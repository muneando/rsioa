<div class="row-fluid">
	<div class="span9">
		<h2><?php echo __('List %s', __('Apartments'));?></h2>
		...
		<?php foreach ($apartments as $apartment): ?>
			<tr>
				...
				<td><?php echo h($apartment['Apartment']['created']); ?>&nbsp;</td>
				<td><?php echo h($apartment['Apartment']['modified']); ?>&nbsp;</td>
				<td class="actions">
					<?php echo $this->Html->link(__('View'), array('action' => 'view', $apartment['Apartment']['id'])); ?>
					<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $apartment['Apartment']['id'])); ?>
					<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $apartment['Apartment']['id']), null, __('Are you sure you want to delete # %s?', $apartment['Apartment']['id'])); ?>
				</td>
			</tr>
		<?php endforeach; ?>
		</table>
